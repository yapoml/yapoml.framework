...
{
    public class ResourceTemplateLoader : Scriban.Runtime.ITemplateLoader
    {
        ...
        public string Load(TemplateContext context, SourceSpan callerSpan, string templatePath)
        {
            ...
            // not been loaded yet
            using (Stream stream = _assembly.GetManifestResourceStream(_assembly.GetName().Name + ".Templates." + Path.GetFileName(templatePath) + ".scriban"))
